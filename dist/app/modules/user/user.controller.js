...
exports.deleteUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!mongoose_1.default.Types.ObjectId.isValid(id)) {
        throw new App_Error_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Invalid user ID');
    }
    const deletedUser = yield user_model_1.User.findByIdAndDelete(id); // Physically delete the user
    if (!deletedUser) {
        throw new App_Error_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'User not found');
    }
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
