...
const login = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user) {
        throw new App_Error_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'This user is not found !');
    }
    // checking if the user is blocked
    const userStatus = user === null || user === void 0 ? void 0 : user.status;
    if (userStatus === 'blocked') {
        throw new App_Error_1.default(http_status_codes_1.StatusCodes.FORBIDDEN, 'This user is blocked ! !');
    }
...
const changePassword = (userData, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!(yield user_model_1.User.isPasswordMatched(payload.oldPassword, user === null || user === void 0 ? void 0 : user.password)))
        throw new App_Error_1.default(http_status_codes_1.StatusCodes.FORBIDDEN, 'Password do not matched');
    //hash new password
